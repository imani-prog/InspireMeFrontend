...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-emerald-600 via-green-600 to-teal-700">
      {/* Animated Background Blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-48 h-48 md:w-72 md:h-72 bg-lime-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float"></div>
        <div className="absolute top-40 right-10 w-48 h-48 md:w-72 md:h-72 bg-cyan-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute -bottom-8 left-40 w-48 h-48 md:w-72 md:h-72 bg-teal-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
      </div>
          ...
          <header className="text-center mb-8 sm:mb-12 md:mb-16 animate-slideUp">
            <div className="inline-block relative">
              ...
              <div className="relative">
                ...
                <div className="h-1 sm:h-1.5 md:h-2 bg-gradient-to-r from-lime-400 via-emerald-400 to-teal-400 rounded-full"></div>
              </div>
            </div>
