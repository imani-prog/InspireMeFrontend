  ...
  return (
    <div className={`max-w-4xl mx-auto relative group px-4 sm:px-6 ${className}`}>
      ...
      <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-6 md:p-8 lg:p-12 border border-white/20 transform transition-all duration-500 hover:scale-[1.02]">
        ...
        {/* Author Section */}
        <div className="mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-6 md:pt-8 border-t-2 border-blue-500 flex items-center justify-end gap-2 sm:gap-3 md:gap-4">
        ...
        {/* Decorative Stars */}
        <div className="absolute top-4 sm:top-6 right-4 sm:right-6 text-blue-600 opacity-50 animate-pulse text-sm sm:text-base">
          <SparklesIcon className="w-4 h-4 sm:w-5 sm:h-5" />
        </div>
        <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-blue-600 opacity-50 animate-pulse text-sm sm:text-base" style={{animationDelay: '0.5s'}}>
