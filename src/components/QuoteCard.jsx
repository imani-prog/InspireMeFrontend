...
export default function QuoteCard({ quote, className = '' }) {
  ...
  return (
    <div className={`max-w-4xl mx-auto relative group ${className}`}>
      {/* Glow Effect */}
      <div className="absolute -inset-0.5 bg-gradient-to-r from-lime-500 via-emerald-500 to-teal-500 rounded-2xl sm:rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
      
      {/* Main Card */}
      <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 lg:p-12 border border-white/20 transform transition-all duration-500 hover:scale-[1.02]">
        ...
        {/* Quote Icon */}
        <div className="absolute -top-4 sm:-top-6 left-6 sm:left-12 bg-gradient-to-r from-emerald-500 to-lime-500 rounded-full p-2 sm:p-3 md:p-4 shadow-lg">
        ...
        {/* Author Section */}
        <div className="mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-6 md:pt-8 border-t-2 border-gradient-to-r from-emerald-200 via-lime-200 to-teal-200 flex items-center justify-end gap-2 sm:gap-3 md:gap-4">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="hidden sm:block h-0.5 sm:h-1 w-8 sm:w-12 md:w-16 bg-gradient-to-r from-emerald-400 to-lime-400 rounded-full"></div>
            <div className="text-right">
              <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-lime-600">
                {author}
              </div>
            </div>
          </div>
